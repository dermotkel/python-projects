...
with open("data/iris.csv") as f:
    for line in f:
        ...
        f = ('{:.1f}   {:.1f}   {:.1f}   {:.1f}'.format(f[0], f[1], f[2], f[3])) # The spaces between the curly brackets matches the spaces in the output. This formating creates a list storing the values with one decimel place. Cite: https://mkaz.tech/code/python-string-format-cookbook/
        print(f)
